...
class NewCustomerFrame(customtkinter.CTkFrame):
    ...
    def setup_form_new_customer(self):
        ...
        self.frame_new_customer.grid(row=0, column=0, rowspan=10, sticky="nsew")
        ...
        self.new_customer_input = customtkinter.CTkEntry(self.frame_new_customer, placeholder_text="Name", master=self)
        self.new_customer_input.grid(row=1, column=0, pady=12, padx=10, sticky="nsew")
